                  ...
                  ?>
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <a class="badge badge-danger" href='ohcms_pages_employee_manage_iward_patients.php?del=<?php echo $row->p_id; ?>' onClick="return confirm('Remove  This Record?');"><i class="mdi mdi-delete"></i> Delete</a>
                          <a class="badge badge-primary" href='ohcms_pages_employee_update_iward_patients.php?p_id=<?php echo $row->p_id; ?>'><i class="mdi mdi-check-circle"></i> Update</a>
                          <a class="badge badge-success" href='ohcms_pages_employee_view_out_patient_details.php?p_id=<?php echo $row->p_id; ?>'><i class="mdi mdi-eye-check-outline"></i> View</a>
                        </td>
                      </tr>
                    </tbody>
                  <?php $cnt = $cnt + 1;
