            ...
            <div class="col-12 col-lg-12">
              <div id="printDetails" class="invoice">
                ...
                <div class="row invoice-header">
                  ...
                  <div class="col-sm-5 invoice-order"><span class="invoice-id">Knowledge Base ID #<?php echo $row->kb_id; ?></span></div>
                </div>
                <div class="row invoice-data">
                  <div class="col-sm-5 invoice-person">KnowlegdeBase Name:<span class="name"><?php echo $row->kb_name; ?></span><span></span><span></span></div>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <table class="invoice-details">
                      <tr>
                        <th style="width:60%;">Knowledge Base Description</th>
                      </tr>
                      <tr>
                        <td><?php echo $row->kb_desc; ?></td>
                      </tr>
                    </table>
                  </div>
                </div>
