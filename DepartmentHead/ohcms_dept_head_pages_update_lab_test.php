                ...
                ?>
                  <form method="POST">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <textarea class="form-control" id="editor1" name="p_diagonisis" type="text"><?php echo $row->p_diagonisis; ?></textarea>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Laboratory Tests</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <textarea class="form-control" id="editor2" value="" name="p_lab_tests" type="text"></textarea>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Laboratory Results</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <textarea class="form-control" id="editor3" value="" name="p_lab_results" type="text"></textarea>
                      </div>
                    </div>
