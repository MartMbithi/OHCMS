                  ...
                  ?>
                    <tbody class="no-border-x">
                      <tr>
                        ...
                        <td>
                          <a class="badge badge-primary" href='ohcms_employee_pages_capture_employee_vitals.php?em_id=<?php echo $row->em_id; ?>'><i class="mdi mdi-check-circle"></i> Capture Vitals</a>
                          <a class="badge badge-success" href='ohcms_employee_pages_view_employee_vitals.php?em_id=<?php echo $row->em_id; ?>'><i class="mdi mdi-eye-check-outline"></i> View Vitals</a>
                        </td>
                      </tr>
                    </tbody>
                  <?php $cnt = $cnt + 1;
