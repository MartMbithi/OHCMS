...
check_login();
$aid = $_SESSION['em_id'];
if (isset($_POST['administer_drug'])) {
  $p_id = $_GET['p_id'];
                ...
                ?>
                  <form method="POST">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <textarea class="form-control" id="editor2" value="" name="p_drug_admin" type="text"></textarea>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <p class="text-right">
                        <button class="btn btn-space btn-primary" name="administer_drug" type="submit">Save</button>
