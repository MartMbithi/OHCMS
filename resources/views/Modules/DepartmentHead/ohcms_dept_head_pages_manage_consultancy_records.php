                  ...
                  <table class="table table-striped table-hover table-fw-widget" id="table1">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><a class="badge badge-danger" href='ohcms_dept_head_pages_manage_consultancy_records.php?del=<?php echo $row->id;?>' onClick= "return confirm('Remove  This Record?');"><i class="mdi mdi-delete"></i> Delete</a>
                            <a class="badge badge-success" href='ohcms_dept_head_pages_view_consultation.php?id=<?php echo $row->id;?>'><i  class="mdi mdi-eye-check-outline"></i> View</a></td>
                      </tr>
                    </tbody>
                  <?php $cnt=$cnt+1; }?>
