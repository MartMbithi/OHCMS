          ...
          <div class="col-sm-12">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Advance Search Pharmaceuticals</li>
              </ol>
            </nav>
                  ...
                  ?>
                    <tbody class="no-border-x">
                      <tr>
                        ...
                        <td> <a class="badge badge-success" href='ohcms_dept_head_pages_view_single_pharmaceutical.php?pharm_id=<?php echo $row->pharm_id; ?>'><i class="mdi mdi-eye-check-outline"></i> View</a></td>
                      </tr>
                    </tbody>
                  <?php $cnt = $cnt + 1;
                  } ?>
