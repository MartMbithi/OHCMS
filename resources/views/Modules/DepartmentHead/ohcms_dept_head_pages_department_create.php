...
if (isset($_POST['add_dept'])) {
  ...
  $query = "insert into departments  (dept_name, dept_head, dept_desc) values(?,?,?)";
  $stmt = $mysqli->prepare($query);
  //bind the submitted values with the matching columns in the database.
  $rc = $stmt->bind_param('sss', $dept_name, $dept_head, $dept_desc);
  $stmt->execute();
                ...
                <form method="POST">
                  <div class="form-group row">
                    ...
                    <div class="col-12 col-sm-8 col-lg-6">
                      <input class="form-control" id="inputText3" name="dept_name" type="text">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Department Head</label>
                    <div class="col-12 col-sm-8 col-lg-6">
                      <input class="form-control" id="inputText3" name="dept_head" type="text">
                    </div>
                  </div>
                  <div class="form-group row">
