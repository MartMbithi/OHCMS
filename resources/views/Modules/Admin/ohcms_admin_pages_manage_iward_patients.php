                  ...
                  ?>
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <a class="badge badge-danger" href='ohcms_admin_pages_manage_iward_patients.php?del=<?php echo $row->p_id; ?>' onClick="return confirm('Remove  This Record?');"><i class="mdi mdi-delete"></i> Delete</a>
                          <a class="badge badge-primary" href='ohcms_admin_pages_update_iward_patients.php?p_id=<?php echo $row->p_id; ?>'><i class="mdi mdi-check-circle"></i> Update</a>
