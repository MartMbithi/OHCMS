            ...
            <div class="col-12 col-lg-12">
              ...
              <div id="printDetails" class="invoice">
                ...
                <div class="row invoice-header">
                  ...
                  <div class="col-sm-5 invoice-order"><span class="invoice-id">Employee Number #<?php echo $row->em_id; ?></span></div>
                </div>
                <div class="row invoice-data">
                  <div class="col-sm-5 invoice-person">Name :<span class="name"><?php echo $row->em_fname; ?> <?php echo $row->em_lname; ?></span>Address :<span><?php echo $row->em_address; ?></span><span></span></div>
