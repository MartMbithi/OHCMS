                  ...
                  ?>
                    <tbody class="no-border-x">
                      <tr>
                        ...
                        <td><a class="badge badge-success" href='ohcms_admin_pages_update_lab_test.php?p_id=<?php echo $row->p_id; ?>'><i class="mdi mdi-flask"></i>Lab Test</a></td>
                      </tr>
                    </tbody>
                  <?php $cnt = $cnt + 1;
                  } ?>
                  ...
                  ?>
                    <tbody class="no-border-x">
                      <tr>
                        ...
                        <td><a class="badge badge-success" href='ohcms_admin_pages_view_outpatient_lab_results.php?p_id=<?php echo $row->p_id; ?>'><i class="mdi mdi-eye-check-outline"></i> View</a></td>
                      </tr>
                    </tbody>
                  <?php $cnt = $cnt + 1;
                  } ?>
