                  ...
                  ?>
                    <tbody class="no-border-x">
                      <tr>
                        ...
                        <td>
                          <a class="badge badge-danger" href='ohcms_admin_pages_manage_regdesk_employee.php?del=<?php echo $row->em_id; ?>' onClick="return confirm('Remove  This Record?');"><i class="mdi mdi-delete"></i> Delete</a>
