                  ...
                  ?>
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <a href='ohcms_pages_employee_manage_iward_patients.php?del=<?php echo $row->p_id; ?>' onClick="return confirm('Remove  This Record?');"><i class="mdi mdi-delete"></i></a>
                          <a href='ohcms_pages_employee_update_iward_patients.php?p_id=<?php echo $row->p_id; ?>'><i class="mdi mdi-check-circle"></i></a>
