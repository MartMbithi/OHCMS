    ...
    <footer class="pt-4 my-md-5 pt-md-5 border-top">
      <div class="row">
        <div class="col-12 col-md">
          <small class="d-block mb-3 text-muted">&copy; All Rights Reserved Orion Healthcare Hospital Management System 2019-<?php echo date('Y'); ?>. Crafted With Love by <a href="https://martmbithi.github.io" target="_blank">MartDevelopers</a>.</small>
        </div>
    </footer>
  </div>
</body>
