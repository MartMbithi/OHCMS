...
<!--Header-->
  ...
  <body>
    <div class="be-wrapper be-fixed-sidebar">
     ...
     <?php	
                    $id=$_GET['f_id'];
                    $ret="select * from feedback where f_id=?";
            ...
            <div class="col-12 col-lg-12">
              <div id="printDetails" class="invoice">
                ...
                <div class="row invoice-header">
                  ...
                  <div class="col-sm-5 invoice-order"><span class="invoice-id">Feedback ID  #<?php echo $row->f_id;?></span></div>
                </div>
                <div class="row invoice-data">
                  <div class="col-sm-5 invoice-person">Patient Name :<span class="name"><?php echo $row->p_name;?></span><span></span></div>
