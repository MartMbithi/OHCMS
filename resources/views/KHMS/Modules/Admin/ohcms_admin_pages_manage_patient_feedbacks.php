        ...
        <div class="row">
            ...
            <nav aria-label="breadcrumb">
              ...
              <div class="card card-table">
                <div class="card-header">Patients Feedbacks
                  ...
                  <table class="table table-striped table-hover table-fw-widget" id="table1">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                            <a class="badge badge-success" href='ohcms_admin_pages_manage_patient_feedback_details.php?f_id=<?php echo $row->f_id;?>'><i  class="mdi mdi-eye-check-outline"></i> View</a>
