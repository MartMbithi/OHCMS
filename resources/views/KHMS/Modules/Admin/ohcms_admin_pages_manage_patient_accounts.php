                  ...
                  <table class="table table-striped table-hover table-fw-widget" id="table1">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                            <a class="badge badge-success" href='ohcms_admin_pages_manage_patient_account_details.php?p_id=<?php echo $row->p_id;?>'><i  class="mdi mdi-eye-check-outline"></i> Create Account</a>
                            <a class="badge badge-warning" href='ohcms_admin_pages_disable_patient_account_details.php?p_id=<?php echo $row->p_id;?>'><i  class="mdi mdi-eye-check-outline"></i> Deactivate Account</a>
