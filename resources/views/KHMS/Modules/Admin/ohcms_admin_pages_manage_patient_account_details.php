...
$aid=$_SESSION['admin_id'];
    ...
    //sql to inset the values to the database
        $query="update patients set p_email=?, p_passwd=?, acc_status=? where p_id=?";
        $stmt = $mysqli->prepare($query);
        //bind the submitted values with the matching columns in the database.
        $rc=$stmt->bind_param('sssi', $p_email, $p_passwd, $acc_status, $p_id);
        $stmt->execute();
        ...
        <div class="row">
            <div class="col-md-12">
              <div class="card card-border-color card-border-color-primary">
                <div class="card-header card-header-divider">Create Patient Account <span class="card-subtitle">Please fill required details.</span></div>
                <div class="card-body">
                <?php if(isset($msg)) 
                 {?>
                    <script>
                  ...
                  <form method="POST" >
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" id="inputText3" value ="<?php echo $row->p_fname;?> <?php echo $row->p_lname;?> " name="p_fname" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Patient Email Address</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" id="inputText3" name="p_email" type="email">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Patient Password</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" id="inputText3"  name="p_passwd" type="password">
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row" style="display:none">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Account Status</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" id="inputText3" name="acc_status" value="1" type="password">
                      </div>
                    </div>
                    <!--
                    <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <p class="text-right">
                          <button class="btn btn-space btn-primary" name="update_outpatient" type="submit">Create Account</button>
