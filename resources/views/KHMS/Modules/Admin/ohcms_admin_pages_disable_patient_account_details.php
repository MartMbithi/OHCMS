...
$aid=$_SESSION['admin_id'];
    ...
    //sql to inset the values to the database
        $query="update patients set acc_status='0' where p_id=?";
        $stmt = $mysqli->prepare($query);
        //bind the submitted values with the matching columns in the database.
        $rc=$stmt->bind_param('si',$acc_status, $p_id);
        $stmt->execute();
                ...
                ?>
                  <form method="POST" >
                    ...
                    <div class="form-group row" style="display:none">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">D</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" id="inputText3" name="acc_status" type="email">
                      </div>
                    </div>
                    <!--
                    <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <p class="text-right">
                          <button class="btn btn-space btn-primary" name="update_outpatient" type="submit">Deactivate Account</button>
