<head>
    ...
    <title>Orion HealthCare Management Information System</title>

    <!-- Bootstrap Core CSS -->
    <link href="{{ url('css/bootstrap.min.css') }}" rel="stylesheet">
	
	<!-- RS5.0 Main Stylesheet -->
	<link rel="stylesheet" type="text/css" href="{{ url('css/revolution/settings.css')}}">
	
	<!-- RS5.0 Layers and Navigation Styles -->
	<link rel="stylesheet" type="text/css" href="{{ url('css/revolution/layers.css')}}">
	<link rel="stylesheet" type="text/css" href="{{ url('css/revolution/navigation.css')}}"> 
	
    <link href="{{ url('css/style.css')}}" rel="stylesheet">
    
    <!-- Color -->
    <link id="skin" href="{{ url('skins/default.css') }}" rel="stylesheet">
