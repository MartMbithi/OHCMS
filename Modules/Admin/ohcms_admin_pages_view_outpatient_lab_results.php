            ...
            <div class="col-12 col-lg-12">
              <div class="invoice">
                ...
                <div class="row invoice-data">
                  <div class="col-sm-5 invoice-person"><span class="name"><?php echo $row->p_fname;?> <?php echo $row->p_lname;?></span><span><?php echo $row->p_address;?></span><span><?php echo $row->p_age;?> Years Old</span></div>
